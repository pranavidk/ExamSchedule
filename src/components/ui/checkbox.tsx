...
export const CheckBox = memo(function CheckBox({
  ...
  return (
    <div className="select-none cursor-pointer flex-shrink-0" onClick={onClick}>
      <svg width={size} height={size} viewBox="0 0 40 40" fill="none">
        <motion.path
          ...
          strokeLinecap="round"
          strokeWidth={3}
          // initial={false}: skip entrance animation on mount/re-render.
          // Without this, every parent re-render (e.g. the 1-second countdown
          // tick in ExamCard) would restart the draw animation from scratch.
          initial={false}
          animate={{
