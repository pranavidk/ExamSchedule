    ...
    modules: [
      {
        ...
        topics: [
          { id: 'BMAT102L-M1-T1', name: 'Second order non-homogeneous equation with constant coefficients' },
          { id: 'BMAT102L-M1-T2', name: 'Particular Integral by Method of undetermined coefficients' },
          { id: 'BMAT102L-M1-T3', name: 'Particular Integral by Method of variation of parameters' },
          { id: 'BMAT102L-M1-T4', name: 'Second order non-homogeneous equation with variable coefficients, Eulers Cauchy Equation' },
          { id: 'BMAT102L-M1-T5', name: 'Spring Mass System Lecture-1' },
          { id: 'BMAT102L-M1-T6', name: 'Spring Mass System Lecture-II' },
          { id: 'BMAT102L-M1-T7', name: 'LCR circuit Lecture-I' },
          { id: 'BMAT102L-M1-T8', name: 'LCR circuit Lecture-II' },
        ],
      },
      {
        id: 'BMAT102L-M2',
        name: 'Module 2 — Partial Differential Equations',
        topics: [
          { id: 'BMAT102L-M2-T1', name: 'Formation of partial differential equations' },
          { id: 'BMAT102L-M2-T2', name: 'Singular integrals' },
          { id: 'BMAT102L-M2-T3', name: 'Solutions of standard types of first order partial differential equations Lecture-I' },
          { id: 'BMAT102L-M2-T4', name: 'Solutions of standard types of first order partial differential equations Lecture-II' },
          { id: 'BMAT102L-M2-T5', name: 'Lagranges Linear Equation Lecture-I' },
          { id: 'BMAT102L-M2-T6', name: 'Lagranges Linear Equation Lecture-II' },
          { id: 'BMAT102L-M2-T7', name: 'Lagranges Linear Equation Lecture-III' },
          { id: 'BMAT102L-M2-T8', name: 'Solution of PDE using method of Separation of variables Lecture-I' },
          { id: 'BMAT102L-M2-T9', name: 'Solution of PDE using method of Separation of variables Lecture-II' },
        ],
      },
      {
        id: 'BMAT102L-M3',
        name: 'Module 3 — Laplace Transform',
        topics: [
          { id: 'BMAT102L-M3-T1', name: 'Definition, Properties' },
          { id: 'BMAT102L-M3-T2', name: 'Standard functions of Laplace Transforms' },
          { id: 'BMAT102L-M3-T3', name: 'Laplace transform of periodic functions and Problems' },
          { id: 'BMAT102L-M3-T4', name: 'Laplace transform of Unit step function and Problems' },
          { id: 'BMAT102L-M3-T5', name: 'Laplace transform of Unit impulse function and Problems' },
          { id: 'BMAT102L-M3-T6', name: 'Inverse Laplace transform Using Partial fractions Lecture-I' },
          { id: 'BMAT102L-M3-T7', name: 'Inverse Laplace transform Using Partial fractions Lecture-II' },
          { id: 'BMAT102L-M3-T8', name: 'Inverse Laplace transform by convolution theorem' },
        ],
      },
      {
        id: 'BMAT102L-M4',
        name: 'Module 4 — Solutions to ODE and PDE by Laplace Transform',
        topics: [
          { id: 'BMAT102L-M4-T1', name: 'Solution of homogeneous differential equations' },
          { id: 'BMAT102L-M4-T2', name: 'Solution of non homogeneous differential equations' },
          { id: 'BMAT102L-M4-T3', name: 'Solution of non homogeneous differential equations involving Heaviside function' },
          { id: 'BMAT102L-M4-T4', name: 'Solution of non homogeneous differential equations involving Impulse function' },
          { id: 'BMAT102L-M4-T5', name: 'Solution of homogeneous system of equations' },
          { id: 'BMAT102L-M4-T6', name: 'Solution of non-homogeneous system of equations' },
          { id: 'BMAT102L-M4-T7', name: 'Solution of first order Partial differential equation Lecture-I' },
          { id: 'BMAT102L-M4-T8', name: 'Solution of first order Partial differential equation Lecture-II' },
        ],
      },
      {
        id: 'BMAT102L-M5',
        name: 'Module 5 — Fourier Series',
        topics: [
          { id: 'BMAT102L-M5-T1', name: 'Introduction to Fourier Series, Euler formula, Dirichlets condition' },
          { id: 'BMAT102L-M5-T2', name: 'Fourier series expansion on general period and problems' },
          { id: 'BMAT102L-M5-T3', name: 'Fourier series for odd and even functions and problems' },
          { id: 'BMAT102L-M5-T4', name: 'Fourier series for change of interval and problems' },
          { id: 'BMAT102L-M5-T5', name: 'Half range Fourier sine and cosine series Lecture-1' },
          { id: 'BMAT102L-M5-T6', name: 'Half range Fourier sine and cosine series Lecture-II' },
          { id: 'BMAT102L-M5-T7', name: 'RMS Value, Parsavals identity and Problems Lecture-I' },
          { id: 'BMAT102L-M5-T8', name: 'Parsavals identity and Problems Lecture-II' },
        ],
      },
      {
        id: 'BMAT102L-M6',
        name: 'Module 6 — Fourier Transform',
        topics: [
          { id: 'BMAT102L-M6-T1', name: 'Complex Fourier transform and properties' },
          { id: 'BMAT102L-M6-T2', name: 'Relation between Fourier and Laplace Transforms' },
          { id: 'BMAT102L-M6-T3', name: 'Fourier sine, cosine transforms Lecture-I' },
          { id: 'BMAT102L-M6-T4', name: 'Fourier sine, cosine transforms Lecture-II' },
          { id: 'BMAT102L-M6-T5', name: 'Parsevals identity and Problems' },
          { id: 'BMAT102L-M6-T6', name: 'Convolution Theorem and Problems Lecture-I' },
          { id: 'BMAT102L-M6-T7', name: 'Convolution Theorem and Problems Lecture-II' },
          { id: 'BMAT102L-M6-T8', name: 'Application Problems to solve partial differential equations-I' },
          { id: 'BMAT102L-M6-T9', name: 'Application Problems to solve partial differential equations Lecture-II' },
        ],
      },
      {
        id: 'BMAT102L-M7',
        name: 'Module 7 — Z-Transform',
        topics: [
          { id: 'BMAT102L-M7-T1', name: 'Definition of Z-transform and Inverse Z transform' },
          { id: 'BMAT102L-M7-T2', name: 'Standard functions of Z transform' },
          { id: 'BMAT102L-M7-T3', name: 'Inverse Z transform using Partial fraction method' },
          { id: 'BMAT102L-M7-T4', name: 'Inverse Z transform using Convolution theorem Lecture-I' },
          { id: 'BMAT102L-M7-T5', name: 'Inverse Z transform using Convolution theorem Lecture-II' },
          { id: 'BMAT102L-M7-T6', name: 'Solution of First and second order difference equations with constant coefficients' },
          { id: 'BMAT102L-M7-T7', name: 'Solution of difference equations using Z-transforms Lecture-I' },
          { id: 'BMAT102L-M7-T8', name: 'Solution of difference equations using Z-transforms Lecture-II' },
        ],
      },
      {
        id: 'BMAT102L-M8',
        ...
        topics: [
          { id: 'BMAT102L-M8-T1', name: 'Industry Expert Lecture 1' },
          { id: 'BMAT102L-M8-T2', name: 'Industry Expert Lecture 2' },
        ],
      },
    ],
  },
